  ...
  return (
    <>
      <motion.div
        ...
        style={{
          background: `linear-gradient(to top, #F0C06E, rgba(240, 192, 110, 0.8), transparent)`,
        }}
      />
      <AnimatePresence>
  ...
  return (
    <div {...props} className={cn("absolute z-50 h-2 w-2", props.className)}>
      <motion.div
        ...
        style={{
          background: `linear-gradient(to right, transparent, #F0C06E, transparent)`,
        }}
      ></motion.div>
      {spans.map((span) => (
        <motion.span
          ...
          style={{
            background: `linear-gradient(to bottom, #F0C06E, rgba(240, 192, 110, 0.6))`,
          }}
        />
      ))}
    </div>
